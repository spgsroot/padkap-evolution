...
const syncDirs = [
  {
    local: path.resolve(
      process.env.LOCAL_DIR_FE ??
        '../luci-app-padkap-evolution/htdocs/luci-static/resources/view/padkap-evolution',
    ),
    remote:
      process.env.REMOTE_DIR_FE ?? '/www/luci-static/resources/view/padkap-evolution',
  },
  {
    local: path.resolve(
      process.env.LOCAL_DIR_BIN ?? '../padkap-evolution/files/usr/bin/',
    ),
    remote: process.env.REMOTE_DIR_BIN ?? '/usr/bin/',
  },
  {
    local: path.resolve(
      process.env.LOCAL_DIR_LIB ?? '../padkap-evolution/files/usr/lib/',
    ),
    remote: process.env.REMOTE_DIR_LIB ?? '/usr/lib/padkap-evolution/',
  },
  {
    local: path.resolve(
      process.env.LOCAL_DIR_INIT ?? '../padkap-evolution/files/etc/init.d/',
    ),
