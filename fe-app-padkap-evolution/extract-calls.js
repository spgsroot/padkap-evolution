...
const files = await glob([
    'src/**/*.ts',
    '../luci-app-padkap-evolution/htdocs/luci-static/resources/view/padkap-evolution/**/*.js',
], {
    ignore: [
        '**/*.test.ts',
        '**/main.js',
        '../luci-app-padkap-evolution/htdocs/luci-static/resources/view/padkap-evolution/main.js',
    ],
    absolute: true,
});
