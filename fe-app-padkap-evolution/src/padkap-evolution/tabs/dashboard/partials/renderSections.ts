...
interface IRenderSectionsProps {
  ...
  onCopyOutbound: (
    section: PadkapEvolution.OutboundGroup,
    outbound: PadkapEvolution.Outbound,
  ) => void;
  onShowUrlTestInfo: (outbound: PadkapEvolution.Outbound) => void;
  onShowPriorityInfo: (outbound: PadkapEvolution.Outbound) => void;
  onUpdateSubscription: (section: PadkapEvolution.OutboundGroup) => void;
  latencyFetching: boolean;
  latencyProgress?: PadkapEvolution.LatencyActionProgress;
...
function renderSubscriptionMetadata(
  metadata: PadkapEvolution.SubscriptionMetadata | undefined,
) {
...
function renderDefaultState({
  ...
  function renderOutbound(outbound: PadkapEvolution.Outbound) {
