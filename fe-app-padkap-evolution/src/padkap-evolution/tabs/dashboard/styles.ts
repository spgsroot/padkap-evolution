...
@font-face {
    ...
    src: url("/luci-static/resources/view/padkap-evolution/fonts/TwemojiCountryFlags.woff2") format("woff2");
    font-display: swap;
    font-style: normal;
    font-weight: normal;
...
#cbi-${PADKAP_EVOLUTION_CBI_PREFIX}-dashboard-_mount_node > .cbi-value-title {
    display: none;
}

#cbi-${PADKAP_EVOLUTION_CBI_PREFIX}-dashboard-_mount_node > .cbi-value-field {
    margin-left: 0;
    width: 100%;
}

#cbi-${PADKAP_EVOLUTION_CBI_PREFIX}-dashboard-_mount_node > div {
    width: 100%;
}

#cbi-${PADKAP_EVOLUTION_CBI_PREFIX}-dashboard > h3 {
    display: none;
}
