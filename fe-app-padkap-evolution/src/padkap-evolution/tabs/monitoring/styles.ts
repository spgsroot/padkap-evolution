...
export const styles = `
#cbi-${PADKAP_EVOLUTION_CBI_PREFIX}-monitoring-_mount_node {
    margin: 16px 0 22px;
    padding: 0;
}

#cbi-${PADKAP_EVOLUTION_CBI_PREFIX}-monitoring-_mount_node > .cbi-value-title {
    display: none;
}

#cbi-${PADKAP_EVOLUTION_CBI_PREFIX}-monitoring-_mount_node > .cbi-value-field {
    margin-left: 0;
    width: 100%;
}

#cbi-${PADKAP_EVOLUTION_CBI_PREFIX}-monitoring-_mount_node > div {
    width: 100%;
}

#cbi-${PADKAP_EVOLUTION_CBI_PREFIX}-monitoring > h3 {
    display: none;
}
