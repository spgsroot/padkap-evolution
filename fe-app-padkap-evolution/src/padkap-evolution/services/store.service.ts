...
export interface StoreType {
  ...
  servicesInfoWidget: {
    ...
    data: {
      singbox: number;
      padkapEvolutionRunning: number;
      padkapEvolutionEnabled: number;
      padkapEvolutionStatus: string;
    };
  };
  sectionsWidget: {
    loading: boolean;
    ...
    latencyProgressSections: Record<
      string,
  ...
  updatesActions: {
    padkapEvolutionCheck: { loading: boolean };
    padkapEvolutionInstall: { loading: boolean };
...
const initialStore: StoreType = {
  ...
  servicesInfoWidget: {
    ...
    data: {
      singbox: 0,
      padkapEvolutionRunning: 0,
      padkapEvolutionEnabled: 0,
      padkapEvolutionStatus: '',
    },
  },
  sectionsWidget: {
    loading: true,
