...
type UiActionMap = Partial<PadkapEvolution.UiState['actions']>;
...
function getEmptyUpdatesActions(): StoreType['updatesActions'] {
  return {
    padkapEvolutionCheck: { loading: false },
    padkapEvolutionInstall: { loading: false },
...
function applyServiceState(uiState: PadkapEvolution.UiState) {
  ...
  store.set({
    servicesInfoWidget: {
      ...
      data: {
        ...
        padkapEvolutionRunning: uiState.service["padkap-evolution"].running,
        padkapEvolutionEnabled: uiState.service["padkap-evolution"].enabled,
        padkapEvolutionStatus: uiState.service["padkap-evolution"].status,
      },
    },
...
function applyActionState(actions: UiActionMap = {}) {
  ...
  const latencyProgressSections: Record<
    string,
    PadkapEvolution.LatencyActionProgress
  > = {};
...
export function applyUiStateToStore(uiState: PadkapEvolution.UiState) {
