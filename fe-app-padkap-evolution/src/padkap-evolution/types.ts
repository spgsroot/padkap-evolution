...
// eslint-disable-next-line @typescript-eslint/no-namespace
export namespace PadkapEvolution {
  // Available commands:
  // start                   Start padkap-evolution service
  // stop                    Stop padkap-evolution service
  // reload                  Reload padkap-evolution configuration
  // restart                 Restart padkap-evolution service
  // enable                  Enable padkap-evolution autostart
  // disable                 Disable padkap-evolution autostart
  // uninstall               Remove padkap-evolution files installed outside opkg/apk
  // main                    Run main padkap-evolution process
  ...
  // check_logs              Show padkap-evolution logs from system journal
  ...
  // show_config             Display current padkap-evolution configuration
  // show_version            Show padkap-evolution version
  // show_sing_box_config    Show sing-box configuration
  // show_sing_box_version   Show sing-box version
  // get_status              Get padkap-evolution service status
  ...
  export interface GetSystemInfo {
    padkap_evolution_version: string;
    padkap_evolution_latest_version: string;
