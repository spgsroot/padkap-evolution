export const PADKAP_EVOLUTION_UCI_PACKAGE = 'padkap-evolution';
export const PADKAP_EVOLUTION_LUCI_APP_VERSION =
  '__COMPILED_VERSION_VARIABLE__';
export const PADKAP_EVOLUTION_ACTION_PROVIDERS_AVAILABILITY_EVENT =
