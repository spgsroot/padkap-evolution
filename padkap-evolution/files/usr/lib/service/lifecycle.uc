...
const CONFIG_NAME = getenv("PADKAP_EVOLUTION_CONFIG_NAME") || constant_value("PADKAP_EVOLUTION_CONFIG_NAME", "padkap-evolution");
const CONFIG_FILE = getenv("PADKAP_EVOLUTION_CONFIG_FILE") || "/etc/config/" + CONFIG_NAME;
const LIB_DIR = getenv("PADKAP_EVOLUTION_LIB") || "/usr/lib/padkap-evolution";
const BIN_PATH = getenv("PADKAP_EVOLUTION_BIN") || constant_value("PADKAP_EVOLUTION_BIN", "/usr/bin/padkap-evolution");
const SERVICE_INIT = getenv("PADKAP_EVOLUTION_SERVICE_INIT") || constant_value("PADKAP_EVOLUTION_SERVICE_INIT", "/etc/init.d/padkap-evolution");
const SERVICE_NAME = getenv("PADKAP_EVOLUTION_SERVICE_NAME") || constant_value("PADKAP_EVOLUTION_SERVICE_NAME", "padkap-evolution");
const LUCI_VIEW_DIR = getenv("PADKAP_EVOLUTION_LUCI_VIEW_DIR") || constant_value("PADKAP_EVOLUTION_LUCI_VIEW_DIR", "/www/luci-static/resources/view/padkap-evolution");
const LUCI_I18N_DOMAIN = getenv("PADKAP_EVOLUTION_LUCI_I18N_DOMAIN") || constant_value("PADKAP_EVOLUTION_LUCI_I18N_DOMAIN", "padkap-evolution");

const RUNTIME_STATE_DIR = getenv("PADKAP_EVOLUTION_RUNTIME_STATE_DIR") || "/var/run/padkap-evolution";
const SYSTEM_INFO_CACHE_FILE = getenv("PADKAP_EVOLUTION_SYSTEM_INFO_CACHE_FILE") || RUNTIME_STATE_DIR + "/system-info.json";
const RELOAD_STATE_FILE = getenv("PADKAP_EVOLUTION_RELOAD_STATE_FILE") || RUNTIME_STATE_DIR + "/reload-state";
const RELOAD_STATE_SNAPSHOT_FILE = getenv("PADKAP_EVOLUTION_RELOAD_STATE_SNAPSHOT_FILE") || RUNTIME_STATE_DIR + "/reload-state.snapshot." + clock()[0] + "." + clock()[1];
const PENDING_RELOAD_FILE = getenv("PADKAP_EVOLUTION_PENDING_RELOAD_FILE") || RUNTIME_STATE_DIR + "/reload.pending";
const SERVICE_TRIGGER_SYNC_FILE = getenv("PADKAP_EVOLUTION_SERVICE_TRIGGER_SYNC_FILE") || RUNTIME_STATE_DIR + "/service-triggers.sync";
const SUBSCRIPTION_UPDATE_STATE_DIR = getenv("PADKAP_EVOLUTION_SUBSCRIPTION_UPDATE_STATE_DIR") || RUNTIME_STATE_DIR + "/subscription-update";
const SUBSCRIPTION_LINKS_DIR = getenv("PADKAP_EVOLUTION_SUBSCRIPTION_LINKS_DIR") || RUNTIME_STATE_DIR + "/subscription-links";
const SUBSCRIPTION_METADATA_DIR = getenv("PADKAP_EVOLUTION_SUBSCRIPTION_METADATA_DIR") || RUNTIME_STATE_DIR + "/subscription-metadata";
const OUTBOUND_METADATA_DIR = getenv("PADKAP_EVOLUTION_OUTBOUND_METADATA_DIR") || RUNTIME_STATE_DIR + "/outbound-metadata";
const SECTION_CACHE_DIR = getenv("PADKAP_EVOLUTION_SECTION_CACHE_DIR") || RUNTIME_STATE_DIR + "/section-cache";
const RULE_CONDITION_CACHE_DIR = getenv("PADKAP_EVOLUTION_RULE_CONDITION_CACHE_DIR") || RUNTIME_STATE_DIR + "/rule-condition-cache";
const RUNTIME_CACHE_FORMAT_FILE = getenv("PADKAP_EVOLUTION_RUNTIME_CACHE_FORMAT_FILE") || RUNTIME_STATE_DIR + "/cache-format";
const PERSISTENT_SUBSCRIPTION_CACHE_DIR = getenv("PADKAP_EVOLUTION_PERSISTENT_SUBSCRIPTION_CACHE_DIR") || "/etc/padkap-evolution/subscription-cache";
const PERSISTENT_SUBSCRIPTION_CACHE_FORMAT_FILE = getenv("PADKAP_EVOLUTION_PERSISTENT_SUBSCRIPTION_CACHE_FORMAT_FILE") || PERSISTENT_SUBSCRIPTION_CACHE_DIR + "/cache-format";
const PERSISTENT_SUBSCRIPTION_CACHE_FORMAT = getenv("PADKAP_EVOLUTION_PERSISTENT_SUBSCRIPTION_CACHE_FORMAT") || "7";
const SUBSCRIPTION_BOOTSTRAP_RETRY_PID_FILE = getenv("PADKAP_EVOLUTION_SUBSCRIPTION_BOOTSTRAP_RETRY_PID_FILE") || RUNTIME_STATE_DIR + "/subscription-bootstrap-retry.pid";
const DNS_FAILOVER_STATE_FILE = getenv("PADKAP_EVOLUTION_DNS_FAILOVER_STATE_FILE") || RUNTIME_STATE_DIR + "/dns-failover.json";
const DNS_FAILOVER_PID_FILE = getenv("PADKAP_EVOLUTION_DNS_FAILOVER_PID_FILE") || RUNTIME_STATE_DIR + "/dns-failover.pid";
const SUBSCRIPTION_UPDATE_LOCK_DIR = getenv("PADKAP_EVOLUTION_SUBSCRIPTION_UPDATE_LOCK_DIR") || RUNTIME_STATE_DIR + "/subscription-update.lock";
const RELOAD_LOCK_DIR = getenv("PADKAP_EVOLUTION_RELOAD_LOCK_DIR") || "/var/run/padkap-evolution.reload.lock";
const INTERNAL_CONFIG_TRIGGER_GUARD = getenv("PADKAP_EVOLUTION_INTERNAL_CONFIG_TRIGGER_GUARD") || "/var/run/padkap-evolution.internal-config-change";

const LIST_UPDATE_CRON_MARKER = getenv("PADKAP_EVOLUTION_LIST_UPDATE_CRON_MARKER") || "# padkap-evolution-list-update";
const SUBSCRIPTION_UPDATE_CRON_MARKER = getenv("PADKAP_EVOLUTION_SUBSCRIPTION_UPDATE_CRON_MARKER") || "# padkap-evolution-subscription-update";
const COMPONENT_UPDATE_CHECK_CRON_MARKER = getenv("PADKAP_EVOLUTION_COMPONENT_UPDATE_CHECK_CRON_MARKER") || "# padkap-evolution-component-update-check";
const RELOAD_STATE_FORMAT = int(getenv("PADKAP_EVOLUTION_RELOAD_STATE_FORMAT") || "1");
const RUNTIME_CACHE_FORMAT = int(getenv("PADKAP_EVOLUTION_RUNTIME_CACHE_FORMAT") || "8");
const RUNTIME_STABLE_MIN_AGE = int(getenv("PADKAP_EVOLUTION_RUNTIME_STABLE_MIN_AGE") || "2");
const SING_BOX_START_STABLE_MIN_AGE = int(getenv("PADKAP_EVOLUTION_SING_BOX_START_STABLE_MIN_AGE") || "8");
const SING_BOX_START_VERIFY_TIMEOUT = int(getenv("PADKAP_EVOLUTION_SING_BOX_START_VERIFY_TIMEOUT") || "10");
const NFT_POPULATE_ENABLED_DEFAULT = int(getenv("PADKAP_EVOLUTION_NFT_POPULATE_ENABLED") || "1");
...
const RT_TABLE_NAME = constant_value("RT_TABLE_NAME", "padkap-evolution");
const NFT_TABLE_NAME = constant_value("NFT_TABLE_NAME", "PadkapEvolutionTable");
...
const NFT_COMMON_SET_NAME = constant_value("NFT_COMMON_SET_NAME", "padkap_evolution_subnets");
const NFT_COMMON6_SET_NAME = constant_value("NFT_COMMON6_SET_NAME", "padkap_evolution_subnets6");
const NFT_PORT_SET_NAME = constant_value("NFT_PORT_SET_NAME", "padkap_evolution_ports");
const NFT_IP_PORT_SET_NAME = constant_value("NFT_IP_PORT_SET_NAME", "padkap_evolution_ip_ports");
const NFT_IP_PORT6_SET_NAME = constant_value("NFT_IP_PORT6_SET_NAME", "padkap_evolution_ip6_ports");
const NFT_INTERFACE_SET_NAME = constant_value("NFT_INTERFACE_SET_NAME", "padkap_evolution_interfaces");
...
const SB_VARIANT_STATE_FILE = constant_value("SB_VARIANT_STATE_FILE", "/etc/padkap-evolution/sing-box-variant");
const SB_VERSION_STATE_FILE = constant_value("SB_VERSION_STATE_FILE", "/etc/padkap-evolution/sing-box-version");
...
let subscription_caches_prepared = getenv("PADKAP_EVOLUTION_SUBSCRIPTION_CACHES_PREPARED") || "0";
let subscription_runtime_no_refresh = getenv("PADKAP_EVOLUTION_SUBSCRIPTION_RUNTIME_NO_REFRESH") || "0";
...
function lifecycle_env() {
    return {
        PADKAP_EVOLUTION_CONFIG_NAME: CONFIG_NAME,
        PADKAP_EVOLUTION_LIB: LIB_DIR,
        PADKAP_EVOLUTION_BIN: BIN_PATH,
        PADKAP_EVOLUTION_SERVICE_INIT: SERVICE_INIT,
        PADKAP_EVOLUTION_RUNTIME_STATE_DIR: RUNTIME_STATE_DIR,
        PADKAP_EVOLUTION_SYSTEM_INFO_CACHE_FILE: SYSTEM_INFO_CACHE_FILE,
        PADKAP_EVOLUTION_SUBSCRIPTION_UPDATE_STATE_DIR: SUBSCRIPTION_UPDATE_STATE_DIR,
        PADKAP_EVOLUTION_SUBSCRIPTION_LINKS_DIR: SUBSCRIPTION_LINKS_DIR,
        PADKAP_EVOLUTION_SUBSCRIPTION_METADATA_DIR: SUBSCRIPTION_METADATA_DIR,
        PADKAP_EVOLUTION_OUTBOUND_METADATA_DIR: OUTBOUND_METADATA_DIR,
        PADKAP_EVOLUTION_SECTION_CACHE_DIR: SECTION_CACHE_DIR,
        PADKAP_EVOLUTION_RULE_CONDITION_CACHE_DIR: RULE_CONDITION_CACHE_DIR,
        PADKAP_EVOLUTION_RUNTIME_CACHE_FORMAT_FILE: RUNTIME_CACHE_FORMAT_FILE,
        PADKAP_EVOLUTION_RUNTIME_CACHE_FORMAT: as_string(RUNTIME_CACHE_FORMAT),
        PADKAP_EVOLUTION_PERSISTENT_SUBSCRIPTION_CACHE_DIR: PERSISTENT_SUBSCRIPTION_CACHE_DIR,
        PADKAP_EVOLUTION_PERSISTENT_SUBSCRIPTION_CACHE_FORMAT_FILE: PERSISTENT_SUBSCRIPTION_CACHE_FORMAT_FILE,
        PADKAP_EVOLUTION_PERSISTENT_SUBSCRIPTION_CACHE_FORMAT: PERSISTENT_SUBSCRIPTION_CACHE_FORMAT,
        PADKAP_EVOLUTION_SUBSCRIPTION_BOOTSTRAP_RETRY_PID_FILE: SUBSCRIPTION_BOOTSTRAP_RETRY_PID_FILE,
        PADKAP_EVOLUTION_DNS_FAILOVER_STATE_FILE: DNS_FAILOVER_STATE_FILE,
        PADKAP_EVOLUTION_DNS_FAILOVER_PID_FILE: DNS_FAILOVER_PID_FILE,
        PADKAP_EVOLUTION_SUBSCRIPTION_UPDATE_LOCK_DIR: SUBSCRIPTION_UPDATE_LOCK_DIR,
        PADKAP_EVOLUTION_PENDING_RELOAD_FILE: PENDING_RELOAD_FILE,
        PADKAP_EVOLUTION_RELOAD_LOCK_DIR: RELOAD_LOCK_DIR,
        ...
        PADKAP_EVOLUTION_RULE_CONDITION_CACHE_ENABLED: as_string(rule_condition_cache_enabled)
    };
}
...
function dnsmasq_has_padkap_evolution_managed_state() {
...
function start_main() {
    ...
    log_message("Starting Padkap Evolution", "info");
    ...
    status = module_status(STATE_UC, [
        "wait-padkap-evolution-stable-start",
        RT_TABLE_NAME,
        NFT_TABLE_NAME,
        NFT_FAKEIP_MARK,
...
function start_impl() {
    ...
    else if (dnsmasq_has_padkap_evolution_managed_state()) {
...
function stop_main() {
    ...
    log_message("Stopping Padkap Evolution", "info");
...
function cleanup_failed_runtime() {
    ...
    log_message("Cleaning up Padkap Evolution runtime after failed start/reload", "info");
    ...
    if (status != 0)
        log_message("Failed to fully clean up Padkap Evolution runtime after start/reload failure", "warn");
...
function start() {
    ...
    if (status != 0) {
        log_message("Startup verification failed after Padkap Evolution was started; rolling back DNS changes", "warn");
        cleanup_failed_runtime();
        return status;
    }
...
function restart_runtime_for_reload() {
    ...
    log_message("Reload requires a full Padkap Evolution runtime restart", "info");
    ...
    if (status != 0) {
        log_message("Reload runtime restart verification failed after Padkap Evolution was started; rolling back DNS changes", "fatal");
        cleanup_failed_runtime();
        return status;
    }
...
function reload(reason) {
    ...
    log_message("Reloading Padkap Evolution", "info");
    ...
    if (!module_success(STATE_UC, [ "padkap-evolution-running", RT_TABLE_NAME, NFT_TABLE_NAME, NFT_FAKEIP_MARK ])) {
        log_message("Runtime state is incomplete; restarting Padkap Evolution runtime", "info");
    ...
    let dnsmasq_managed_state = dnsmasq_has_padkap_evolution_managed_state() ? 1 : 0;
    ...
    if (as_string(getenv("PADKAP_EVOLUTION_RUNTIME_CACHE_INVALIDATED") || "0") == "1" ||
    ...
    if (plan_result.status != 0) {
        if (plan_result.status == 2) {
            log_message("Reload state is unavailable; restarting Padkap Evolution runtime", "info");
            return finish_reload_status(restart_runtime_for_reload(), reload_config_fingerprint);
        }
    ...
    if (plan.needs_sing_box_reload == 1) {
        ...
        if (status != 0) {
            log_message("Reload verification failed after sing-box was reloaded; stopping Padkap Evolution runtime", "fatal");
            cleanup_failed_runtime();
            return status;
        }
        status = module_status(PRIORITY_UC, [ "start-runtime" ]);
...
function reload_tracked(reason) {
    if (as_string(getenv("PADKAP_EVOLUTION_UI_ACTION_TRACKED") || "0") == "1")
...
function restart() {
    log_message("Restarting Padkap Evolution", "info");
    ...
    if (module_success(STATE_UC, [
        "padkap-evolution-stably-running",
        RT_TABLE_NAME,
        NFT_TABLE_NAME,
        NFT_FAKEIP_MARK,
        as_string(RUNTIME_STABLE_MIN_AGE)
    ...
    log_message("Restart verification failed after Padkap Evolution was started; stopping Padkap Evolution runtime", "fatal");
    cleanup_failed_runtime();
    return 1;
}
...
function uninstall() {
    log_message("Uninstalling Padkap Evolution", "info");
    ...
    if (fs.stat("/etc/init.d/padkap-evolution") != null) {
        command_success_from_args([ "/etc/init.d/padkap-evolution", "stop" ]);
        command_success_from_args([ "/etc/init.d/padkap-evolution", "disable" ]);
    }

    package_manager_remove_if_installed("luci-i18n-padkap-evolution-ru");
    package_manager_remove_if_installed("luci-app-padkap-evolution");
    ...
    command_success_from_args([ "rm", "-rf", "/usr/lib/padkap-evolution" ]);
    command_success_from_args([ "rm", "-rf", LUCI_VIEW_DIR ]);
    remove_file(SERVICE_INIT);
    remove_file(BIN_PATH);
    remove_file("/usr/share/luci/menu.d/luci-app-padkap-evolution.json");
    remove_file("/usr/share/rpcd/acl.d/luci-app-padkap-evolution.json");
    remove_file("/etc/uci-defaults/50_luci-padkap-evolution");
