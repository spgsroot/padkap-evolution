...
const BIN_PATH = getenv("PADKAP_EVOLUTION_BIN") || "/usr/bin/padkap-evolution";
...
const LIST_UPDATE_STATE_FILE = getenv("PADKAP_EVOLUTION_LIST_UPDATE_STATE_FILE") || RUNTIME_STATE_DIR + "/list-update.timestamp";
const LIST_UPDATE_PID_FILE = getenv("PADKAP_EVOLUTION_LIST_UPDATE_PID_FILE") || "/var/run/padkap_evolution_list_update.pid";
...
const SUBSCRIPTION_JOB_DIR = getenv("PADKAP_EVOLUTION_SUBSCRIPTION_UPDATE_JOB_DIR") || "/var/run/padkap-evolution/subscription-update-jobs";
...
const RUNTIME_CACHE_FORMAT = getenv("PADKAP_EVOLUTION_RUNTIME_CACHE_FORMAT") || "8";
...
const RELOAD_STATE_FORMAT = getenv("PADKAP_EVOLUTION_RELOAD_STATE_FORMAT") || "1";
...
const SERVICE_INIT = getenv("PADKAP_EVOLUTION_SERVICE_INIT") || "/etc/init.d/padkap-evolution";
const PRIORITY_UC = getenv("PADKAP_EVOLUTION_PRIORITY_UC") || LIB_DIR + "/singbox/priority.uc";
const DNS_FAILOVER_UC = getenv("PADKAP_EVOLUTION_DNS_FAILOVER_UC") || LIB_DIR + "/singbox/dns_failover.uc";
const COMPONENT_JOB_DIR = getenv("UPDATES_JOB_DIR") || getenv("PADKAP_EVOLUTION_UI_COMPONENT_ACTION_DIR") || "/var/run/padkap-evolution/component-actions";
const COMPONENT_UPDATE_CHECK_CACHE_DIR = getenv("PADKAP_EVOLUTION_COMPONENT_UPDATE_CHECK_CACHE_DIR") || RUNTIME_STATE_DIR + "/component-update-checks";
const COMPONENT_UPDATE_CHECK_STATE_FILE = getenv("PADKAP_EVOLUTION_COMPONENT_UPDATE_CHECK_STATE_FILE") || RUNTIME_STATE_DIR + "/component-update-check.timestamp";
const COMPONENT_UPDATE_CHECK_LOCK_DIR = getenv("PADKAP_EVOLUTION_COMPONENT_UPDATE_CHECK_LOCK_DIR") || RUNTIME_STATE_DIR + "/component-update-check.lock";
...
const COMPONENT_JOB_STALE_GRACE_SECONDS = getenv("UPDATES_JOB_STALE_GRACE_SECONDS") || getenv("PADKAP_EVOLUTION_UI_ACTION_STALE_GRACE_SECONDS") || "15";
const SUBSCRIPTION_JOB_FINISHED_TTL_MINUTES = getenv("PADKAP_EVOLUTION_SUBSCRIPTION_UPDATE_JOB_FINISHED_TTL_MINUTES") || "60";
const SUBSCRIPTION_JOB_ORPHAN_OUTPUT_TTL_MINUTES = getenv("PADKAP_EVOLUTION_SUBSCRIPTION_UPDATE_JOB_ORPHAN_OUTPUT_TTL_MINUTES") || "60";
const SUBSCRIPTION_JOB_STALE_GRACE_SECONDS = getenv("PADKAP_EVOLUTION_UI_ACTION_STALE_GRACE_SECONDS") || "15";
const NFT_TABLE_NAME = getenv("NFT_TABLE_NAME") || "PadkapEvolutionTable";
const NFT_COMMON_SET_NAME = getenv("NFT_COMMON_SET_NAME") || "padkap_evolution_subnets";
const NFT_COMMON6_SET_NAME = getenv("NFT_COMMON6_SET_NAME") || "padkap_evolution_subnets6";
const NFT_IP_PORT_SET_NAME = getenv("NFT_IP_PORT_SET_NAME") || "padkap_evolution_ip_ports";
const NFT_IP_PORT6_SET_NAME = getenv("NFT_IP_PORT6_SET_NAME") || "padkap_evolution_ip6_ports";
const NFT_DISCORD_SET_NAME = getenv("NFT_DISCORD_SET_NAME") || "padkap_evolution_discord_subnets";
const NFT_DISCORD6_SET_NAME = getenv("NFT_DISCORD6_SET_NAME") || "padkap_evolution_discord_subnets6";
const NFT_INTERFACE_SET_NAME = getenv("NFT_INTERFACE_SET_NAME") || "padkap_evolution_interfaces";
...
function ensure_subscription_runtime_dirs() {
    let command = command_env({
        ...
        PADKAP_EVOLUTION_RUNTIME_CACHE_FORMAT: RUNTIME_CACHE_FORMAT,
...
function subscription_worker_env() {
    return {
        ...
        PADKAP_EVOLUTION_RUNTIME_STATE_DIR: RUNTIME_STATE_DIR,
        PADKAP_EVOLUTION_SUBSCRIPTION_UPDATE_STATE_DIR: SUBSCRIPTION_UPDATE_STATE_DIR,
        PADKAP_EVOLUTION_SUBSCRIPTION_UPDATE_JOB_DIR: SUBSCRIPTION_JOB_DIR,
        PADKAP_EVOLUTION_SUBSCRIPTION_LINKS_DIR: SUBSCRIPTION_LINKS_DIR,
        PADKAP_EVOLUTION_SUBSCRIPTION_METADATA_DIR: SUBSCRIPTION_METADATA_DIR,
        PADKAP_EVOLUTION_OUTBOUND_METADATA_DIR: OUTBOUND_METADATA_DIR,
        PADKAP_EVOLUTION_SECTION_CACHE_DIR: SECTION_CACHE_DIR,
        ...
        PADKAP_EVOLUTION_PERSISTENT_SUBSCRIPTION_CACHE_FORMAT_FILE: PERSISTENT_SUBSCRIPTION_CACHE_FORMAT_FILE,
        PADKAP_EVOLUTION_PERSISTENT_SUBSCRIPTION_CACHE_FORMAT: PERSISTENT_SUBSCRIPTION_CACHE_FORMAT,
        PADKAP_EVOLUTION_SUBSCRIPTION_UPDATE_JOB_FINISHED_TTL_MINUTES: SUBSCRIPTION_JOB_FINISHED_TTL_MINUTES,
        PADKAP_EVOLUTION_SUBSCRIPTION_UPDATE_JOB_ORPHAN_OUTPUT_TTL_MINUTES: SUBSCRIPTION_JOB_ORPHAN_OUTPUT_TTL_MINUTES,
        PADKAP_EVOLUTION_UI_ACTION_STALE_GRACE_SECONDS: SUBSCRIPTION_JOB_STALE_GRACE_SECONDS
    };
}
...
function valid_component_name(component) {
    ...
    return component == "padkap-evolution" || component == "sing_box" || component == "zapret" ||
...
function component_update_check_cache() {
    ...
    if (enabled) {
        for (let component in [ "padkap-evolution", "sing_box", "zapret", "zapret2", "byedpi" ]) {
...
function component_worker_env() {
    return {
        ...
        PADKAP_EVOLUTION_UI_COMPONENT_ACTION_TRACKED: "1"
    };
}
...
function subscription_update_common(force, target_section, target_source_index) {
    ...
    if (!acquire_runtime_lock(RELOAD_LOCK_DIR, force)) {
        ...
        log_message("Padkap Evolution reload is already running; skipping subscription update", "info");
        if (force)
