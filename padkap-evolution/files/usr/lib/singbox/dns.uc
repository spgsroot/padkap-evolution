...
const DNS_FAILOVER_STATE_FILE = getenv("PADKAP_EVOLUTION_DNS_FAILOVER_STATE_FILE") || "/var/run/padkap-evolution/dns-failover.json";
const DNS_HEALTH_ADDRESS = getenv("PADKAP_EVOLUTION_DNS_HEALTH_ADDRESS") || "127.0.0.42";
const DNS_HEALTH_PORT_BASE = int(getenv("PADKAP_EVOLUTION_DNS_HEALTH_PORT_BASE") || "10053");
