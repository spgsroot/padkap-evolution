...
const NFT_PORT_SET_NAME = getenv("NFT_PORT_SET_NAME") || "padkap_evolution_ports";
...
const SB_MANAGED_SERVICE_MARKER = getenv("SB_MANAGED_SERVICE_MARKER") || "Padkap Evolution managed sing-box service for binary variants";
...
function service_listen_address_value(settings) {
    ...
    log_message("Failed to determine the listening IP address. Please open an issue to report this problem: https://github.com/spgsroot/padkap-evolution/issues", "error");
    return "";
}
