...
function add_tailscale_endpoint(config, section, tag_name) {
    ...
    let endpoint = {
        type: "tailscale",
        tag: tag_name,
        state_directory: "/etc/padkap-evolution/tailscale/" + safe_filename(section_name),
        ...
        hostname: option(section, "tailscale_hostname", "padkap-evolution-" + safe_filename(section_name))
    };
