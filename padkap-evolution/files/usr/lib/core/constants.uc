...
function constants_map() {
    ...
    c.PADKAP_EVOLUTION_VERSION = env("PADKAP_EVOLUTION_VERSION", "__COMPILED_VERSION_VARIABLE__");
    c.PADKAP_EVOLUTION_CONFIG_NAME = env("PADKAP_EVOLUTION_CONFIG_NAME", "padkap-evolution");
    c.PADKAP_EVOLUTION_CONFIG = env("PADKAP_EVOLUTION_CONFIG", "/etc/config/" + c.PADKAP_EVOLUTION_CONFIG_NAME);
    c.PADKAP_EVOLUTION_BIN = env("PADKAP_EVOLUTION_BIN", "/usr/bin/padkap-evolution");
    c.PADKAP_EVOLUTION_SERVICE_NAME = env("PADKAP_EVOLUTION_SERVICE_NAME", "padkap-evolution");
    c.PADKAP_EVOLUTION_SERVICE_INIT = env("PADKAP_EVOLUTION_SERVICE_INIT", "/etc/init.d/padkap-evolution");
    c.PADKAP_EVOLUTION_RELEASE_REPO = env("PADKAP_EVOLUTION_RELEASE_REPO", "spgsroot/padkap-evolution");
    c.PADKAP_EVOLUTION_LUCI_VIEW_NAMESPACE = env("PADKAP_EVOLUTION_LUCI_VIEW_NAMESPACE", "padkap-evolution");
    c.PADKAP_EVOLUTION_LUCI_VIEW_DIR = env("PADKAP_EVOLUTION_LUCI_VIEW_DIR", "/www/luci-static/resources/view/" + c.PADKAP_EVOLUTION_LUCI_VIEW_NAMESPACE);
    c.PADKAP_EVOLUTION_LUCI_I18N_DOMAIN = env("PADKAP_EVOLUTION_LUCI_I18N_DOMAIN", "padkap-evolution");
    ...
    c.RT_TABLE_NAME = env("RT_TABLE_NAME", "padkap-evolution");

    c.NFT_TABLE_NAME = env("NFT_TABLE_NAME", "PadkapEvolutionTable");
    c.NFT_LOCALV4_SET_NAME = env("NFT_LOCALV4_SET_NAME", "localv4");
    c.NFT_LOCALV6_SET_NAME = env("NFT_LOCALV6_SET_NAME", "localv6");
    c.NFT_COMMON_SET_NAME = env("NFT_COMMON_SET_NAME", "padkap_evolution_subnets");
    c.NFT_COMMON6_SET_NAME = env("NFT_COMMON6_SET_NAME", "padkap_evolution_subnets6");
    c.NFT_PORT_SET_NAME = env("NFT_PORT_SET_NAME", "padkap_evolution_ports");
    c.NFT_IP_PORT_SET_NAME = env("NFT_IP_PORT_SET_NAME", "padkap_evolution_ip_ports");
    c.NFT_IP_PORT6_SET_NAME = env("NFT_IP_PORT6_SET_NAME", "padkap_evolution_ip6_ports");
    c.NFT_DISCORD_SET_NAME = env("NFT_DISCORD_SET_NAME", "padkap_evolution_discord_subnets");
    c.NFT_DISCORD6_SET_NAME = env("NFT_DISCORD6_SET_NAME", "padkap_evolution_discord_subnets6");
    c.NFT_INTERFACE_SET_NAME = env("NFT_INTERFACE_SET_NAME", "padkap_evolution_interfaces");
    ...
    c.SB_MANAGED_SERVICE_MARKER = env("SB_MANAGED_SERVICE_MARKER", "Padkap Evolution managed sing-box service for binary variants");
    ...
    c.SB_VARIANT_STATE_FILE = env("SB_VARIANT_STATE_FILE", "/etc/padkap-evolution/sing-box-variant");
    c.SB_VERSION_STATE_FILE = env("SB_VERSION_STATE_FILE", "/etc/padkap-evolution/sing-box-version");
    ...
    c.ZAPRET_LEGACY_RUNTIME_BASE_DIR = env("ZAPRET_LEGACY_RUNTIME_BASE_DIR", "/var/run/padkap-evolution/zapret-runtime");
    c.ZAPRET_NFQWS_BIN = env("ZAPRET_NFQWS_BIN", c.ZAPRET_PROVIDER_NFQWS_BIN);
    c.ZAPRET_STATE_DIR = env("ZAPRET_STATE_DIR", "/var/run/padkap-evolution/zapret");
    ...
    c.ZAPRET2_STATE_DIR = env("ZAPRET2_STATE_DIR", "/var/run/padkap-evolution/zapret2");
    ...
    c.BYEDPI_STATE_DIR = env("BYEDPI_STATE_DIR", "/var/run/padkap-evolution/byedpi");
