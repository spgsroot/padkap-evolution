...
function configureDnsFailoverVisibility(option, dnsOption, bootstrapOption) {
  option.depends("dns_server", "__padkap_evolution_multiple_dns__");
  option.depends("bootstrap_dns_server", "__padkap_evolution_multiple_dns__");
  option.retain = true;
...
function createSettingsContent(section, capabilities) {
  ...
  o = section.option(
    ...
    _("Delay in milliseconds before reloading Padkap Evolution after interface UP"),
  );
  o.depends("enable_badwan_interface_monitoring", "1");
  o.default = "2000";
  o.rmempty = false;
  ...
  o = section.option(
    ...
    _("Padkap Evolution will not modify your DHCP configuration"),
  );
  o.default = "0";
  o.rmempty = false;
